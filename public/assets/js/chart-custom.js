...
if(jQuery('#chart-110').length){
  var chart = new ApexCharts(
      document.querySelector("#chart-110"),
      options
  );
  chart.render();
}
...
if(jQuery('#chart-120').length){
  var chart = new ApexCharts(
      document.querySelector("#chart-120"),
      options
  );
...
if(jQuery('#chart-130').length){
  var chart = new ApexCharts(
      document.querySelector("#chart-130"),
      options
  );
  chart.render();
}
...
if(jQuery('#chart-140').length){
  var chart = new ApexCharts(
      document.querySelector("#chart-140"),
      options
  );
