	...
	**/
	var isDragged		= false,
		...
		templates 		= {
							...
							palette 		: $('<div class="col-sm-3 cols-md-3 bg-light rounded pt-4 text-center" style="display:none" id="bcPaint-palette"><h6 class="bg-dark rounded p-3 mb-4 text-white font-weight-normal">Color Palette</h6></div>'),
							color 			: $('<div class="bcPaint-palette-color"></div>'),
							canvasContainer : $('<div class="col-sm-12 col-md-12" id="bcPaint-canvas-container"></div>'),
							canvasPane 		: $('<canvas id="bcPaintCanvas" class="border rounded" style="background:#e9edf4; border-color:#e9edf4!important;"></canvas>'),
							bottom 			: $('<div class="col-sm-12 col-md-12 text-center" id="bcPaint-bottom"></div>'),
							buttonReset 	: $('<button type="button" class="btn btn-secondary btn-sm mr-1" id="bcPaint-reset"><i class="ri-eraser-line"></i> Effacer</button>'),
							buttonSave		: $('<button type="button" class="btn btn-primary btn-sm ml-1" id="bcPaint-export"><i class="ri-download-2-line"></i> Télécharger</button>')
						},
		paintCanvas,
		paintContext;
