...
class SubCategoriesSeeder extends Seeder
{
    ...
    public function run()
    {
        $sub_categories = array(
            ...
            array('id' => '3','categories_id' => '4','title' => 'Liste des Votes','link' => 'votes-list','icon' => NULL,'created_at' => NULL,'updated_at' => NULL),
            ...
            array('id' => '7','categories_id' => '6','title' => 'Dictionnaire','link' => 'system-dictionary','icon' => NULL,'created_at' => NULL,'updated_at' => NULL)
        );
