                            ...
                            <div class="iq-card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <select class="form-control mb-0" id="assignUser" name="assignUser" title="Séléctionner un utilisateur...">
                                            <option selected></option>
                                            @foreach($contacts as $contact)
                                            <option value="{{ $contact->id }}" data-subtext="{{ $contact->email }}">{{ $contact->first_name }} {{ $contact->last_name }}</option>
                                                @endforeach
                                        </select>
                                    </div>
                                </div>
