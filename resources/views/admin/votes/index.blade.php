                ...
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title w-100">
                        <div class="row">
                          ...
                          <h4 class="card-title m-0">Listes des Condidats</h4>
...
<script>
    ...
    {
        console.log(sesssion,commission,discipline)
            ...
            if(data.condidates.length != 0)
            {
              ...
              .append(
                $('<tr>').append(
                  ...
                  $('<td>').addClass('text-center').text(condidate.ar_establishment),
                  $('<td>').addClass('text-center').text(condidate.cin),
                  $('<td>').addClass('text-center').text(condidate.cnrps),
                    $('<td>').addClass('text-center').text(condidate.date_condidate),
                )
              )
            });
            }else
